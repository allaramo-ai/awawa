...
const rules = [
  ...
  'On your turn you can draw once if your hand has fewer than 3 cards, throw one selected card, play up to two playable cards, place one protection card, and then finish your turn.',
  'Protection cards can be dragged onto your protection row above each Awawa slot.',
  'Aguila attacks to the right. It prefers an Awawa marked by Awawa, then one marked by Solcito or Exploring, then one marked Escaping, and then an unprotected Awawa. It can skip fully protected players until it finds a valid target. After choosing Aguila, you must pick a valid Awawa on that player board and confirm with Eat or cancel the action.',
  ...
  'Oloroso uses a two-step action. Choose an Awawa with an empty protection slot on the next eligible player to your right, then confirm. That Awawa is protected for 2 turns, any protections immediately to its left or right are removed, and those left or right slots are marked Escaping and cannot receive protections while Oloroso remains.',
  'Explorar uses a two-step action. Choose any Awawa on the next eligible player to your right and confirm with Explore or cancel. Its protection slot becomes Exploring for 2 turns. If Aguila does not eat it first, then when Exploring ends on that player turn they send it onward to the next eligible player.',
  'Awawa is dragged onto your own protection row, then you choose which unprotected Awawa to take from the next eligible player to the right. That player loses the chosen unprotected Awawa, and your chosen slot becomes Awawa P#.',
  'Correr is a temporary protection card. It blocks Aguila for 2 turns of the protected player and then disappears.',
  'Escalar is a temporary protection card like Correr. It lasts 2 turns and, when it expires, you choose one Roca to remove from the next eligible player to the right who still has one. If no player has a Roca, you cannot place Escalar.',
  ...
  'Eat uses a two-step action. Choose one Planta protection from the next eligible player to your right, then confirm with Eat or cancel. If no player has a Planta, you cannot play Eat.',
